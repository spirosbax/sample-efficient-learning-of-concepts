...
from experiment.rff_experiment import do_rff_experiment
from experiment.rff_settings import series_params
...
class Task(object):
    ...
    - {self.p_features} fourier features
...
if __name__ == '__main__':   
    ...
    for r, p, d, a, e, m, n in series_params:   
